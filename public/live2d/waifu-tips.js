...
function s(e, t) {
  return new Promise((t, s) => {
    ...
    ;(o = document.createElement('script')),
      (o.src = e),
      o && ((o.onload = () => t(e)), (o.onerror = () => s(e)), document.head.appendChild(o))
  })
}
let o = null
  ...
  static async initCheck(e, t = []) {
    ...
    if (s.useCDN) {
      ...
      s.modelId >= s.models.length && (s.modelId = 0),
        s.modelTexturesId >= s.models[s.modelId].paths.length && (s.modelTexturesId = 0)
    return s
  }
  set modelId(e) {
      ...
      try {
        ...
        if (2 === o) {
          if (!this.cubism2model) {
            if (!this.cubism2Path)
              return void a.error('No cubism2Path set, cannot load Cubism 2 Core.')
          ...
          if (!this.cubism5Path)
            return void a.error('No cubism5Path set, cannot load Cubism 5 Core.')
          await s(this.cubism5Path)
          const { AppDelegate: t } = await import('./chunk/index2.js')
          ;(this.cubism5model = new t()),
            2 === this.currentModelVersion && (this.cubism2model.destroy(), this.resetCanvas()),
            2 !== this.currentModelVersion && this.cubism5model.subdelegates.at(0)
  ...
  async loadRandTexture(e = '', s = '') {
    ...
    if (this.useCDN) {
      ...
      1 === this.models[o].paths.length
        ? (n = !0)
        : (this.modelTexturesId = t(this.models[o].paths.length, this.modelTexturesId))
      ...
      (function (t) {
        ...
        t.seasons.forEach(({ date: t, text: s }) => {
          ...
          Number(i.split('/')[0]) <= o.getMonth() + 1 &&
            ...
            ((s = (s = e(s)).replace('{year}', String(o.getFullYear()))), n.push(s))
        }),
          ...
          window.addEventListener('click', s => {
            ...
            for (let { selector: n, text: l } of t.click)
              if (null === (o = s.target) || void 0 === o ? void 0 : o.closest(n))
                return (l = e(l)), (l = l.replace('{text}', s.target.innerText)), void i(l, 4e3, 8)
          }),
